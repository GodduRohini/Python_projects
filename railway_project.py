...
if logged_in_account is not None:
    trains = [
        Train("12737", "Vizag", "Secunderabad", 67),
        Train("12728", "Hyderabad", "Chennai", 34),
        Train("22863", "Vijayawada", "Bangalore", 21)
    ]
for train in trains:
    train.display_info()
while True:
